                      ...
                      <td key={date} style={{ padding: "8px", textAlign: "center" }}>
                        <button
                          ...
                          style={{
                            ...
                            padding: isCompactViewport ? "4px 7px" : "8px 14px",
                            borderRadius: isCompactViewport ? "5px" : "6px",
                            cursor: isLockedDate ? "not-allowed" : "pointer",
                            fontWeight: 700,
                            fontSize: isCompactViewport ? "11px" : "14px",
                            transition: "all 0.15s ease",
                            minWidth: isCompactViewport ? "32px" : "50px",
                            height: isCompactViewport ? "28px" : "38px",
                            display: "flex",
                            alignItems: "center",
